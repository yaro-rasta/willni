# 🏛️ Центральний Індекс Суверенності

Цей документ є навігатором по матеріалах, що стосуються **Суверенності**, **Природного Права** та **Людини Волі** у системі Will-n-i.
...
- [Evidence_Explorer.md](../courts/Evidence_Explorer.md) — Система пошуку та аналізу доказів.
- [manifesto_collection.md](../courts/manifesto_collection.md) — Збірка маніфестацій.
...
- [2023/02/09/uk/case_torture.md](../courts/evidence_logs/2023/02/09/uk/case_torture.md) — Справа про катування.
...
- [sages/philosophy/tyranny_and_sacrifice/synthesis-v5-language-of-intent.md](../sages/philosophy/tyranny_and_sacrifice/synthesis-v5-language-of-intent.md) — Мова Наміру.
- [sages/economy/tax_terror/synthesis.md](../sages/economy/tax_terror/synthesis.md) — Податковий терор та його деконструкція.
- [sages/glossary/pronouns_rule.md](../sages/glossary/pronouns_rule.md) — Правила займенників у суверенному дискурсі.
- [sages/ui_concept/assessment.md](../sages/ui_concept/assessment.md) — Оцінка гідності та суб'єктності.
...
- [Sovereign_Sync.md](../network/Sovereign_Sync.md) — Протоколи синхронізації.
- [Sovereign_Node_Arch.md](../network/Sovereign_Node_Arch.md) — Архітектура суверенного вузла.
- [Sovereign_Mesh_Resilience.md](../network/Sovereign_Mesh_Resilience.md) — Стійкість Mesh-мережі.
...
- [README.md](../README.md) — Вступ для нових учасників.

---

> [!NOTE]
> Цей індекс є динамічним та оновлюється в процесі дослідження системної маніпуляції та розробки Протоколу Суверена.
