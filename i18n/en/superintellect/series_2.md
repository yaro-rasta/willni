...
```mermaid
graph TB
    subgraph Reality ["🌍 External World (Events)"]
        E1[Event 1]
        E2[Event 2]
        E3[Event 3]
    end
    ...
    subgraph Perception ["👁 Perception"]
        Filter["Mental Matrix<br/>(Filters: language, belief, fears)"]
    end

    subgraph Self ["✨ I (Consciousness)"]
        Observer["Observer"]
        Creator["Creator"]
        Victim["Victim"]
    end
    ...
    Creator -.->|"Feedback<br/>(I change the world)"| Reality
