...
## 1. Foundation: Natural Law
Natural law is primary and fundamental. It is a set of inherent rights and principles that belong to every human from birth, regardless of their geographical location, nationality, or social status.

**Key principles:**
- Right to life and bodily integrity.
- Right to free will and self-determination.
- Right to property and the results of one's own labor.
- Right to protect oneself and one's community.

## 2. Positive Law and Tyranny
Any "positive law" (laws issued by the state) must correspond to the principles of natural law.
- If a state law contradicts natural law, it is not a law, but **tyranny**.
- Compliance with tyrannical laws is a crime against humanity.
