...
export default withMermaid(
  defineConfig({
    title: "Will-n-i",
    description: "Superintellect Series & Mental Matrix. Жити по Волі Ra3Om.",
    base: "/willni/",
      ...
      root: {
        ...
        themeConfig: {
          ...
          nav: [
            ...
            { text: "Курс", link: "/superintellect/course" },
    ...
    themeConfig: {
      ...
      footer: {
        message: "мИ обираємо жити по Волі Ra3Om.",
        copyright: 'Copyright © 2026 Спільнота "Люди Волі"',
      },
    },
